# Chapitre : INDEX MONGODB


# Index MongoDB

<iframe allowfullscreen="true" frameborder="0" src="https://www.youtube.com/embed/hL-UCOxfCq8"></iframe>

# Création d'un index à champ unique

<iframe allowfullscreen="true" frameborder="0" src="https://www.youtube.com/embed/qFN6qOuFUEI"></iframe>
...
## Créer un index unique à champ unique
...
Permet `getIndexes()<span> </span>`de voir tous les index créés dans une collection.

`db.customers.getIndexes()`

## Vérifier si un index est utilisé dans une requête

Utiliser `explain()`dans une collection lors de l'exécution d'une requête pour voir le plan d'exécution. Ce plan fournit les détails des étapes d'exécution (IXSCAN, COLLSCAN, FETCH, SORT, etc.).
...
# Comprendre les index multi-clés

<iframe allowfullscreen="true" frameborder="0" src="https://www.youtube.com/embed/Civ908Eav_A"></iframe>
...
Permet `createIndex()`de créer un nouvel index dans une collection. Inclure un objet comme paramètre contenant le champ de tableau et l'ordre de tri. Dans cet exemple, les comptes sont un champ de tableau.
...
Utilisez la fonction describe() dans une collection lors de l'exécution d'une requête pour voir le plan d'exécution. Ce plan fournit les détails des étapes d'exécution (IXSCAN, COLLSCAN, FETCH, SORT, etc.).
...
# Travailler avec des index composés

<iframe allowfullscreen="true" frameborder="0" src="https://www.youtube.com/embed/rxPjWIeuzLs"></iframe>

Consultez le code ci-dessous, qui montre comment créer un index composé dans une collection.

## Créer un index composé

Permet `createIndex()`de créer un nouvel index dans une collection. Entre les parenthèses de createIndex(), incluez un objet contenant deux champs ou plus et leur ordre de tri.
...
## Ordre des champs dans un index composé
...
## Couvrir une requête par l'index
...
<iframe allowfullscreen="true" frameborder="0" src="https://www.youtube.com/embed/bu_CXvigOHg"></iframe>
...
<iframe allowfullscreen="true" frameborder="0" src="https://www.youtube.com/embed/Nd4t_dCti4g"></iframe>
